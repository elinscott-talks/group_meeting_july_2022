...
\begin{frame}{Part 1: Mahler Symphony No. 9}
  \begin{center}
    \url{https://www.youtube.com/watch?v=tkChdHBuoiQ&t=3237s}
  \end{center}
\end{frame}
...
\begin{frame}{Part 2: Sticky Notes and Strong Songs}
  \begin{center}
    ...
    \footnotesize
    \begin{tabular}[t]{ll}
      \onslide<1->{\includegraphics[height=0.5\paperheight]{podcasts/sticky_notes.jpg}} &
      \onslide<3->{\includegraphics[height=0.5\paperheight]{podcasts/strong_songs.jpg}}   \\
